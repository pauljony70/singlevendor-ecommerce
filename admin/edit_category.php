									...
									<div class="form-body" data-example-id="simple-form-inline">
										...
										<form class="form-inline" id="myform">
											<div class="form-group">
												...
												<input type="text" class="form-control ml-2" id="name" placeholder="Category Name" value="<?php echo $catname; ?>"> </input>

											</div>
											<div class="form-group ml-2">
												<label for="image">Image</label>
												<input class="ml-2" type="file" name="1" id="1" required></input>
											</div>
