...
<head>
	...
	<title>Login - <?= get_store_settings('store_name') ?></title>
				...
				<div class="row">
					<div class="login_main_container my-5 px-0">
						...
						<div class="login-wrap">
							<div class="customer_login font-family-lora fw-medium">Login</div>
							...
							<p class="text-start mt-4 black-text">Don't have an account ! <a href="register" class="color-text">Sign Up here</a></p>
						</div>
					</div>
				</div>
			</div>
