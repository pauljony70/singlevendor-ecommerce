                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control ps-1" id="fullname" name="fullname" placeholder="John Doe">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control ps-1" id="email" name="email" placeholder="john@hotmail.com">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control ps-1" id="phone" name="phone" placeholder="0123456789" oninput="enforceMaxLength(this)" maxlength="10">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control ps-1" id="address" name="address" placeholder="Address">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control ps-1" id="pincode" name="pincode" placeholder="123456" oninput="enforceMaxLength(this)" maxlength="6">
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="defaultaddress" name="defaultaddress">
